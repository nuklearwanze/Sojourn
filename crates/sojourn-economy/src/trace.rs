//! Money→mass/Δv traceability tree (R17, FR-EC-805). Every dollar figure is
//! drillable to **sourced leaves** exposing its mass × Δv basis — the honesty
//! contract (Principle VII/VIII). Reused shape from FA-04.
...
pub enum TraceTree {
    ...
    Node {
        /// The operation (e.g. "route-cost = dv × propellant-rate").
        op: String,
        /// The computed value.
        value: f64,
        /// Inputs.
