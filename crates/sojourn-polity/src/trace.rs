//! Traceability tree (R12, FR-PEA-906). Every derived figure (a faction's prestige,
//! the composite score, a candidate's consensus, a contamination penalty) is
//! drillable to **sourced leaves** — the honesty contract (Principle I/VIII). Reused
//! shape from FA-04/06/07/08.
